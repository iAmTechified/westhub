...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        <div class="flex flex-col items-center lg:flex-row lg:justify-between lg:items-center gap-8 md:gap-10 lg:gap-12">
            <div class="max-w-xl">
                <h2 class="text-2xl md:text-4xl font-bold text-primary-300 mb-4 font-display">
                    {{ $title }}</h2>
                <p class="text-neutral-500 text-base md:text-lg text-justify">
                    {{ $description }}</p>
            </div>
