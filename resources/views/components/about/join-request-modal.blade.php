<div class="join-request-modal" data-join-request-modal hidden aria-hidden="true">
    <div class="join-modal-backdrop" data-join-close></div>

    <div class="join-modal-scroll" role="presentation">
        <form class="join-sheet" data-join-form method="POST" action="{{ route('join-requests.store') }}" enctype="multipart/form-data" novalidate>
            @csrf

            <button type="button" class="join-close-button" data-join-close aria-label="Close application form">
                <span aria-hidden="true">&times;</span>
            </button>

            <div class="join-form-message" data-form-message aria-live="polite"></div>
            <input type="hidden" name="applicant_type" value="skilled" data-applicant-type data-required data-label="Professional type">
                ...
                <section class="join-section is-active" data-section="basic">
                    ...
                    <div class="join-section-panel" data-section-panel>
                        <div class="join-type-row" aria-label="Professional type">
                            <button type="button" class="join-type-option is-active" data-type-option="skilled">
                            ...
                            <button type="button" class="join-type-option" data-type-option="non-skilled">
                        ...
                        <div class="join-form-grid">
                            ...
                            <div class="join-field">
                                ...
                                <input class="join-input" type="text" name="home_address" autocomplete="street-address" data-required data-label="Home address">
                                <p class="join-error" data-error></p>
                            </div>
            ...
            <button type="submit" class="join-submit-button mb-4" data-join-submit disabled>Submit Form</button>
        </form>
    </div>
</div>
